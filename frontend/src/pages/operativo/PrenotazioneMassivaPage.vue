          ...
          <div class="card-body p-4">
            <form @submit.prevent="handleSubmit" novalidate>
              ...
              <div class="mb-3">
                ...
                <select v-model="form.corso_id" class="form-select" :disabled="caricandoCorsi">
                  <option value="">{{ caricandoCorsi ? 'Caricamento…' : '— Seleziona corso —' }}</option>
...
function valida() {
  ...
  if (!form.corso_id) { uiStore.avviso('Seleziona un corso.'); return false }
