...
class SlotOrario(Base):
    ...
    docente_id      = Column(Integer, ForeignKey("docenti.id"), nullable=True)  # ← AGGIUNTO
    ...
    __table_args__ = (
        ...
        Index("ix_slot_docente", "docente_id"),  # ← AGGIUNTO
    )
    ...
    docente      = relationship("Docente", foreign_keys=[docente_id])  # ← AGGIUNTO
